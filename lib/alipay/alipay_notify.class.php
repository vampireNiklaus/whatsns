...
class AlipayNotify {
	...
	var $post=null;
     var $get=null;
	function __construct($aliapy_config,&$getparms,&$postparms){
		$this->aliapy_config = $aliapy_config;
		$this->get=$getparms;
		$this->post=$postparms;
	}
    function AlipayNotify($aliapy_config,$getparms,$postparms) {
    	$this->__construct($aliapy_config,$getparms,$postparms);
    }
    /**
