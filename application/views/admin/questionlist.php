...
<form action="index.php?admin_question/searchquestion{$setting['seo_suffix']}" method="post">
 ...
 注册日期:</label>
  ...
  到</label>
            ...
            <tr>
              <td  rowspan="2" class="altbg2"><input class="btn btn-info" type="submit" value="提 交"></td>
              </tr>
        </tbody>
    </table>
</form>
...
<form name="queslist" method="POST">
    <table class="table">
        ...
        <tr>
          ...
          {if $question['shangjin']>0}<label class="label">悬赏{$question['shangjin']}元</label>{/if}  <a href="index.php?question/view/{$question['id']}{$setting['seo_suffix']}" target="_blank">{eval echo cutstr($question['title'],46,'');}</a></td>
        ...
        <tr class="altbg1">
            <td colspan="9">
             <input name="ctrlcase" class="btn" type="button" onClick="buttoncontrol(9);" value="推送到百度">&nbsp;&nbsp;&nbsp;
               ...
               <input name="ctrlcase" class="btn" type="submit" onClick="buttoncontrol(8);" value="设为已解决">&nbsp;&nbsp;&nbsp;
