...
<form action="index.php?admin_usergroup/regular/$group['groupid']{$setting['seo_suffix']}" method="post">
    ...
    <table width="100%" cellspacing="1" cellpadding="4" align="center" class="tableborder">
        ...
        <tr id="regular_view">
            ...
            <td class="altbg2">
                <div style="width: 200px; float: left;">
                    <input name="regular_code[]" value="user/register,user/editimg"  {if false!==strpos($group['regulars'],'user/register')}checked{/if}  class="checkbox" type="checkbox">用户注册
                </div>
                <div style="width: 200px; float: left;">
                    <input name="regular_code[]" value="index/default"  {if false!==strpos($group['regulars'],'index/default')}checked{/if}  class="checkbox" type="checkbox">首页浏览
                </div>
                <div style="width: 200px; float: left;">
                ...
                <div style="width: 200px; float: left;">
                    <input name="regular_code[]" value="category/list"  {if false!==strpos($group['regulars'],'category/list')}checked{/if}  class="checkbox" type="checkbox">列表浏览
                </div>
                <div style="width: 200px; float: left;">
                ...
                <div style="width: 200px; float: left;">
                    <input name="regular_code[]" value="topic/default"  {if false!==strpos($group['regulars'],'topic/default')}checked{/if}  class="checkbox" type="checkbox">知识专题
                </div>
                <div style="width: 200px; float: left;">
                ...
                <div style="width: 200px; float: left;">
                    <input name="regular_code[]" value="user/space_ask,user/space_answer,user/space"  {if false!==strpos($group['regulars'],'user/space_ask,user/space_answer,user/space')}checked{/if}  class="checkbox" type="checkbox">用户空间
                </div>
        ...
        <tr id="regular_user">
            ...
            <td class="altbg2">
                <div style="width: 200px; float: left;">
                    <input name="regular_code[]" value="user/register"  {if false!==strpos($group['regulars'],'user/register')}checked{/if}  class="checkbox" type="checkbox">注册用户
                </div>
                <div style="width: 200px; float: left;">
                ...
                <div style="width: 200px; float: left;">
                    <input name="regular_code[]" value="user/default,user/score"  {if false!==strpos($group['regulars'],'user/default,user/score')}checked{/if}  class="checkbox" type="checkbox">我的积分
                </div>
                <div style="width: 200px; float: left;">
        ...
        <tr id="regular_setting">
            ...
            <td class="altbg2">
                <div style="width: 200px; float: left;">
                    <input name="regular_code[]" value="admin_main/default,admin_main/header,admin_main/menu,admin_main/stat,admin_main/login,admin_main/logout"  {if false!==strpos($group['regulars'],'admin_main/default,admin_main/header,admin_main/menu,admin_main/stat,admin_main/login,admin_main/logout')}checked{/if}  class="checkbox" type="checkbox">后台登录
                </div>
                <div style="width: 200px; float: left;">
                ...
                <div style="width: 200px; float: left;">
                    <input name="regular_code[]" value="admin_setting/mail"  {if false!==strpos($group['regulars'],'admin_setting/mail')}checked{/if}  class="checkbox" type="checkbox">邮件设置
                </div>
                <div style="width: 200px; float: left;">
                ...
                <div style="width: 200px; float: left;">
                    <input name="regular_code[]" value="admin_setting/passport"  {if false!==strpos($group['regulars'],'admin_setting/passport')}checked{/if}  class="checkbox" type="checkbox">通行证
                </div>
                <div style="width: 200px; float: left;">
