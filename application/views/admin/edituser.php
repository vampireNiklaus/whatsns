...
<input type="hidden" name="uid" value="{$member['uid']}" />
			<table class="table">
				...
				<tr>
					...
					<tr>
					<td class="altbg1" width="45%"><b>用户钱包金额:</b><br><span class="smalltxt">用户账户金额【单位：元】,可以修改</span></td>
					<td class="altbg2"><input class="text"  name="jine" value="{eval echo ($member['jine']/100);}" />元</td>
				</tr>
				<tr>
					<td class="altbg1" width="45%"><b>付费对Ta提问支付:</b><br><span class="smalltxt">用户对Ta提问需支付金额</span></td>
					<td class="altbg2"><input class="text"  name="mypay" value="{$member['mypay']}" />元</td>
				</tr>
				<tr>
