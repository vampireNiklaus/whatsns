...
<table class="table">
    ...
    <tr class="altbg2"><td>
            ...
            {if isset($navlist)}
            <!--{loop $navlist $nav}-->
            &gt;&gt; <a href="{url admin_category/view/$nav['id']}">{$nav['name']}</a>
            <!--{/loop}-->
            {/if}
...
<form name="myform" method="POST">
        ...
        <tr class="header" align="center" style="font-weight:bold;">
            ...
            <td class="" width="10%">专栏名称</td>
             <td class="" width="10%">首页显示(一级分类有效)</td>
              <td class="" width="10%">应用问答</td>
               <td class="" width="10%">应用文章</td>
   ...
   <input class="btn btn-success" tabindex="3" type="button" onClick="buttoncontrol(1);" value=" 删除分类 " name="delete" />&nbsp;&nbsp;&nbsp;
    ...
    <input class="btn btn-success" tabindex="3" type="button"  onClick="buttoncontrol(2);" value=" 首页显示/不显示 " name="indexbtn" />&nbsp;&nbsp;&nbsp;
       <input class="btn btn-success" tabindex="3" type="button"  onClick="buttoncontrol(3);" value="应用/不应用到问答" name="wendabtn" />&nbsp;&nbsp;&nbsp;
         <input class="btn btn-success" tabindex="3" type="button"  onClick="buttoncontrol(4);" value="应用/不应用到文章" name="wenzhangbtn" />&nbsp;&nbsp;&nbsp;
</form>
