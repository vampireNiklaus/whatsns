...
<div class="input-prepend mar-t-1">
        <input placeholder="注册用户名/邮箱号/手机号码" type="text" value="" id="popusername" name="username">
      <i class="fa fa-user"></i>
    </div>

    <div class="input-prepend ">
      <input placeholder="用户密码" type="password" id="poppassword" name="password" autocomplete="off" maxlength="20">
