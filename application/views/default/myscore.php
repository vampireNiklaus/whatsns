...
<div class="container person">
 ...
 <li class="active"><a href="{url user/default}"><i class="fa fa-clipboard"></i> 动态</a></li>
...
<ul class="note-list">
    ...
    <li id="" data-note-id="" {if isset($question['image'])}  class="have-img" {else}class="" {/if}>
...
{/if}
        ...
        {eval echo clearhtml($question['category']['miaosu']);}
        </div>
    </div>
          ...
          <a class="title" target="_self"  href="{$question['url']}"  >{$question['content']}</a>
             {if $user['uid']!=$question['topic']['authorid']&&$question['topic']['price']>0}
                         ...
                         <div class="box_toukan">
											...
											<a  class="thiefbox font-12" style="color:#fff;text-decoration:none;" ><i class="icon icon-lock font-12"></i> &nbsp;阅读需支付&nbsp;$question['topic']['price']&nbsp;&nbsp;积分……</a>
