...
<!--banner-->
<div class="whatsns_banner">
<div class="container">
    <div  class="ws_form_search">
    <form name="searchform" action="{url question/search}" method="post" accept-charset="UTF-8">
        <input name="utf8" type="hidden" value="✓">
        <input type="text" tabindex="1" name="word" id="search-kw" value="{if isset($word)}$word{/if}" placeholder="{$setting['search_placeholder']}"  class="search-input s_input">
...
$expert['author_has_vertify']!=false}<i class="fa fa-vimeo v_person   " data-toggle="tooltip" data-placement="right" title="" data-original-title="认证用户"></i>{/if} </span>
           ...
           <div class="tag">{eval echo clearhtml($expert['signature'],30);}</div>
           </a>
