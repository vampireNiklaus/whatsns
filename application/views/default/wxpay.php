...
<div class=" btn btn-success btn-dashang mar-t-1 wxpayblock" onclick="dashang()">微  信<span class="payjine"></span></div>

<button type="submit" name="alipaysubmit" class=" btn btn-success btn-dashang mar-t-1 wxpayblock" onclick="zhifubao()">支付宝<span class="payjine"></span></button>
