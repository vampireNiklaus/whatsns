...
<div class="row">
   <div class="col-xs-17 side-box main" style="margin-top:20px;">
             ...
             <ul class="nav  mar-t-1">
                ...
                <li class="b-b-line mar-t-1">
                    ...
                    <div class="col-sm-20">
                     ...
                     <div class="col-sm-4 doingfollow">
                    ...
                    <!--{if $recommanduser['is_follow']}-->
                        <a class="btn btn-success button_attention " onclick="attentto_user($recommanduser['uid'])" id="attenttouser_{$recommanduser['uid']}">取消关注</a>
                          <!--{else}-->
                           <a class="btn btn-success button_attention " onclick="attentto_user($recommanduser['uid'])" id="attenttouser_{$recommanduser['uid']}" ><i class="fa fa-plus"></i>关注</a>
                            <!--{/if}-->
                    </div>
                ...
                <li class="b-b-line mar-t-1">
                    <div class="row">
                       <div class="col-sm-2">
                        ...
                        <div class="detail hide"><p>{eval echo cutstr($doing['content'],500)}</p></div>
                        <div class="related">
                         {if $doing['action']!=10&&$doing['action']!=11&&$doing['action']!=12}
                            <div class="pv c-hui">{$doing['attentions']} 人关注 <span class="dot">•</span> {$doing['answers']} 个回答 <span class="dot">•</span> {$doing['views']} 次浏览 </div>
                         {/if}
                        </div>
                        <!--{if $doing['referid']}-->
