...
<ul class="user-list">
  ...
  {if  $follower['hasfollower']}
   <a class="btn btn-default following" id="attenttouser_{$follower['uid']}" onclick="attentto_user($follower['uid'])"><i class="fa fa-check"></i><span>已关注</span></a>
  {else}
   <a class="btn btn-success follow" id="attenttouser_{$follower['uid']}" onclick="attentto_user($follower['uid'])"><i class="fa fa-plus"></i><span>关注</span></a>
  {/if}
