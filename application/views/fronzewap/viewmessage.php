...
<!--{template user_title}-->
 ...
 <button type="button" class="ui-btn ui-btn-danger  mar-ly-1" onclick="javascript:document.location = '{url message/send}'">写消息</button>
 </p>
</div>
                    ...
                    <div class="clearfix"></div>
                             ...
                             <!--{if 'personal'==$type}-->
                               ...
                               <div class="col-sm-24">
                                     ...
                                     <ul class="nav message-items">
                <form class="form-horizontal message-form"   name="commentform" action="{url message/send}" method="POST" onsubmit="return check_form();">
                    <li>
                    <div class="row">
