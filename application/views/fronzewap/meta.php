...
<head lang="ch">
    ...
    <link rel="stylesheet" href="{if $setting['wap_domain']}http://{$setting['wap_domain']}/{else}{SITE_URL}{/if}static/css/fronze/css/frozen.css">
    <link rel="stylesheet" href="{if $setting['wap_domain']}http://{$setting['wap_domain']}/{else}{SITE_URL}{/if}static/css/fronze/css/main.css">

    <link rel="stylesheet" media="all" href="{SITE_URL}static/css/fronze/css/green.css" />
