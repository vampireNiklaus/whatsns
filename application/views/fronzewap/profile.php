 ...
 <div class="ui-row">
         ...
         <div class="ui-row">
          ...
          <div class="ui-col ui-col-75">
           ...
           <div class="ui-row">
          <p class="ui-col ui-col-25 text-left ">邮箱地址：</p>
         ...
         <div class="ui-row">
          ...
          <div class="ui-col ui-col-75 ui-form-item ui-form-item-pure ui-border-b">
            <textarea name="introduction" id="introduction" style="width:90%;height:89px;" class="form-control" >{$user['introduction']}</textarea>
         ...
         <div class="ui-row">
          ...
          <div class="ui-col ui-col-75 ui-form-item ui-form-item-pure ui-border-b">
                                    <textarea name="signature" id="signature" style="width:90%;height:89px;" class="form-control" maxlength="200">{$user['signature']}</textarea>
