 ...
 <form class="form-horizontal mar-t-1 f-addarticle" action="{url user/editxinzhi}"   method="post" enctype="multipart/form-data">
    ...
    {/if}              
         ...
         <div class="form-group">
          ...
          <div class="col-md-24 has-error">
           ...
           <div class="ui-form-item ui-form-item-r ui-border-b" style="padding-left:0px;">
            ...
            <div class="ui-select">
                              <select  name="topicclass" id="srchcategory">
         ...
         <div class="form-group ">
          ...
          <div class="col-md-24 has-error">
            <input type="text" data-toggle="tooltip" data-placement="bottom" title="" placeholder="标签之间英文逗号隔开" data-original-title="英文逗号隔开,最多5个" name="topic_tag" value="{$topic['topic_tag']}"  class="txt_tag" >
