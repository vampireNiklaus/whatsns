...
class Ucenter_model extends CI_Model{
    function ucentermodel() {
       parent::__construct ();
        ...
        @include APPPATH . 'data/ucconfig.inc.php';
        !defined('UC_API') && define('UC_API', '1');
        require_once APPPATH . 'third_party/uc_client/client.php';
    }
...
/* 同步uc注册 */
 ...
 /* 同步uc注册 */
    ...
    function ajaxregister($username,$password,$email,$frominvatecode='') {
