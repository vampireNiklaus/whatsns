...
class Usergroup_model extends CI_Model {
	...
	function update($groupid, $group) {
		$data = array ('grouptitle' => $group ['grouptitle'], 'creditslower' => $group ['creditslower'], 'creditshigher' => $group ['creditshigher'], 'doarticle' => $group ['doarticle'], 'articlelimits' => $group ['articlelimits'], 'questionlimits' => $group ['questionlimits'], 'answerlimits' => $group ['answerlimits'], 'credit3limits' => $group ['credit3limits'], 'regulars' => $group ['regulars'] );
