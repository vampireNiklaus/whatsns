...
class Inform extends CI_Controller {
	...
	function add() {
		...
		empty ( $this->input->post ('group-type') ) && $this->message ( '请选择举报类型，谢谢！', 'BACK' );
		empty ( $this->input->post ('type') ) && $this->message ( '请选择举报原因，谢谢！', 'BACK' );
		empty ( $this->input->post ('content') ) && $this->message ( '请填写举报描述，谢谢！', 'BACK' );
